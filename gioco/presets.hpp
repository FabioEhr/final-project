...
City Bologna(Virus &new_virus){
  ...
  Age Elders= {0.999, 0.001, 0., 0., 0., -2, 20, 0.2, 0.25};
...
City Milano(Virus &new_virus){
  ...
  Age Elders= {0.999, 0.001, 0., 0., 0., -4, 20, 0.2, 0.25};

  Transmatrix Mobility= {3, 2, 0.6, 0.8, 0.4, 0.6 };
...
City Matera(Virus &new_virus){
  ...
  Age Elders= {0.999, 0.001, 0., 0., 0., -1, 20, 0.2, 0.25};
