...
// CHANGES VALUES IN DECISIONS.HPP MIGHT INFLUENCE THEESE RESULTS. PLEASE
// REMEMBER TO UPDATE
...
void invest_in_research_no_stdout(
    City& playground)  // identical from the one used in main, except for std
                       // output,input
