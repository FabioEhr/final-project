...
TEST_CASE("Testing different contagiousness"){
    ...
    CHECK(d_comp(test_1.situationP.infected+test_1.situationP.suscettibles+test_1.situationP.recovered, 0.99, 1.01) );
 CHECK(d_comp(test_2.situationP.infected+test_2.situationP.suscettibles+test_2.situationP.recovered, 0.99, 1.01) );
}
...
CHECK(d_comp(test_1.situationP.infected+test_1.situationP.suscettibles+test_1.situationP.recovered, 0.99, 1.01) );
 CHECK(d_comp(test_2.situationP.infected+test_2.situationP.suscettibles+test_2.situationP.recovered, 0.99, 1.01) );
 CHECK(d_comp(test_3.situationP.infected+test_3.situationP.suscettibles+test_3.situationP.recovered, 0.99, 1.01) );
 CHECK(d_comp(test_4.situationP.infected+test_4.situationP.suscettibles+test_4.situationP.recovered, 0.99, 1.01) );
test_1.evolveNTimes(5);
test_2.evolveNTimes(5);
test_3.evolveNTimes(5);
test_4.evolveNTimes(5);
